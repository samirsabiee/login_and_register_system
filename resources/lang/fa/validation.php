...
return [
    ...
    */
    ...
    'active_url'           => 'لینک :attribute معتبر نیست.',
    ...
    */
    ...
    'attributes' => [
        ...
        'ticket_id'             => 'تیکت',
        'ticketmessage'         => 'پیام',
        'ticketmessage_id'      => 'پیام',
        'user'                  => 'کاربر',
        'user_id'               => 'کاربر',
        'otp_code'              => 'کد اعتبارسنجی',
        'otp_code_type'         => 'نوع اعتبارسنجی',
    ],
    ...
    'exceptions' => [
        ...
        'AuthorizationException' => 'شما دسترسی به این قسمت ندارید.',
        'ThrottleRequestsException' => 'درخواست های شما بیش از حد مجاز می باشد، لطفا دقایقی دیگر تلاش کنید.',
        'ModelNotFoundException' => ':attribute مورد نظر یافت نشد.',
        'TokenInvalidException' => 'توکن کاربری نامعتبر است.',
        'TokenExpiredException' => 'توکن کاربری شما منقضی شده، لطفا مجددا وارد شوید.',
        'JWTException' => 'خطایی در توکن کاربری رخ داده است.',

        'BlockDomainException' => 'دامنه لینک وارد شده قابل ثبت نمی باشد.',
        'SmsServiceException' => 'ارتباط با پنل پیامکی برقرا نشد، لطفا با پشتیبانی در ارتباط باشید.',
    ]
];
